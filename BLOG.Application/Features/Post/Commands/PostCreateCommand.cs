...
namespace BLOG.Application.Features.Post.Commands
{
    ...
    public class PostCreateCommandHandler : IRequestHandler<PostCreateCommand, Result<bool>>
    {
        ...
        public PostCreateCommandHandler(IMediator mediator, IMapper mapper, AppDbContext appDbContext, IHttpContextAccessor httpContextAccessor, UserManager<ApplicationUser> userManager)
        {
            _mediator = mediator;
            _mapper = mapper;
